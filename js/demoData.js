function loadDemoData() {
  ...
  rackSpecs.forEach((spec, index) => {
    ...
    // UPS - VLAN 20
    const upsId = uid();
    devices.push({ id: upsId, rackId, name: `UPS ${spec.name}`, type: 'ups', slotStart: 1, size: 2, ip: `10.10.20.${spec.id_num}`, mac: `00:11:22:33:20:${spec.id_num.toString(16)}`, serial: `UPS-${spec.id_num}`, brand: 'APC', model: 'Smart-UPS X 3000', power: 3000, plugs: 8, user: 'admin', pass: 'ups123', notes: 'VLAN 20 - UPS' });
    ...
    if(spec.id_num === 101) {
      devices.push({ id: firewallId, rackId, name: `Firewall Edge`, type: 'firewall', slotStart: 42, size: 1, ip: '10.10.10.1', mac: '12:34:56:78:90:01', serial: 'FW-01', brand: 'Fortinet', model: 'FortiGate 100F', power: 100, plugs: 1, user: 'admin', pass: 'fortinet', notes: 'VLAN 10 - Gateway' });
      devices.push({ id: coreSwitchId, rackId, name: `Core Switch`, type: 'switch', slotStart: 41, size: 1, ip: '10.10.10.2', mac: '12:34:56:78:90:02', serial: 'CSW-01', brand: 'Cisco', model: 'Nexus 9300', power: 300, plugs: 2, user: 'admin', pass: 'cisco', notes: 'VLAN 10 - Core' });
  ...
  devices.push(
    // Cámaras - VLAN 60
    { id: cam1, rackId: null, category: 'floor', roomId: r1, name: 'Cámara 01', type: 'camera', ip: '10.10.60.10', mac: '', serial: '', brand: 'Axis', model: 'P3245-V', power: 15, plugs: 1, user: 'admin', pass: '', notes: 'VLAN 60' },
    { id: cam2, rackId: null, category: 'floor', roomId: r2, name: 'Cámara 02', type: 'camera', ip: '10.10.60.11', mac: '', serial: '', brand: 'Axis', model: 'P3245-V', power: 15, plugs: 1, user: 'admin', pass: '', notes: 'VLAN 60' },
    { id: cam3, rackId: null, category: 'floor', roomId: r3, name: 'Cámara 03', type: 'camera', ip: '10.10.60.12', mac: '', serial: '', brand: 'Axis', model: 'P3245-V', power: 15, plugs: 1, user: 'admin', pass: '', notes: 'VLAN 60' },
    // Impresoras - VLAN 70
    { id: prt1, rackId: null, category: 'floor', roomId: r1, name: 'Impresora Administración', type: 'printer', ip: '10.10.70.10', mac: '', serial: '', brand: 'HP', model: 'LaserJet Pro', power: 150, plugs: 1, user: '', pass: '', notes: 'VLAN 70' },
    { id: prt2, rackId: null, category: 'floor', roomId: r2, name: 'Impresora Finanzas', type: 'printer', ip: '10.10.70.11', mac: '', serial: '', brand: 'HP', model: 'LaserJet Pro', power: 150, plugs: 1, user: '', pass: '', notes: 'VLAN 70' },
    { id: prt3, rackId: null, category: 'floor', roomId: r3, name: 'Impresora Recepción', type: 'printer', ip: '10.10.70.12', mac: '', serial: '', brand: 'HP', model: 'LaserJet Pro', power: 150, plugs: 1, user: '', pass: '', notes: 'VLAN 70' },
    // Telefonía - VLAN 80
    { id: tel1, rackId: null, category: 'floor', roomId: r2, name: 'Teléfono 01', type: 'phone', ip: '10.10.80.10', mac: '', serial: '', brand: 'Cisco', model: 'IP Phone 8841', power: 10, plugs: 1, user: '', pass: '', notes: 'VLAN 80' },
